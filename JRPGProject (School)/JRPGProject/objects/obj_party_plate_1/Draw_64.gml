...
// Temp font storage
if(global.currentPartyMem == 0) draw_set_color(c_maroon);
else if(global.battlersActive[0] == 0) draw_set_color(c_gray);
else draw_set_color(c_black);

var oldFont = draw_get_font();
draw_set_font(ft_basic);

draw_text(textXmod + x, (y - 2) + textYmod, playerName);
...
if(global.battlersActive[0] != 0) draw_healthbar(x, y + 27, x + 93, y + 31, playerMP, c_black, c_navy, c_blue, 0, true, true);
